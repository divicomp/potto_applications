...
def plot_heavisides(num_heaviside=10, load_local=False):
    ...
    axs[0].set_xlabel("Number of Deltas")
    axs[0].set_ylabel("Time(s)")
    axs[0].set_yscale('log')
    axs[0].set_title("Compile Time")
    ...
    axs[1].set_xlabel("Number of Deltas")
    ...
    axs[2].set_xlabel("Number of Deltas")
    ...
    axs[3].set_xlabel("Number of Deltas")
    axs[3].set_ylabel("# AST Node")
    axs[3].set_title("Number of AST Nodes")
    ...
    fig.tight_layout()
    plt.savefig("heavisides.png", bbox_inches = "tight")
...
def plot_shader_swaps(num_shader_swap=10, load_local=False):
    ...
    fig, axs = plt.subplots(1, 4, figsize=(12, 3))
    axs[0].set_xlabel("Number of Shader Swaps")
    axs[0].set_ylabel("Time(s)")
    axs[0].set_yscale('log')
    axs[0].set_title("Compile Time")
    axs[0].set_yticks([1e-4, 1e-3, 1e-2, 1e-1, 0])
    ...
    axs[1].set_xlabel("Number of Shader Swaps")
    axs[1].set_ylabel("Time(s)")
    axs[1].set_yscale('log')
    axs[1].set_title("Evaluation Time")
    axs[1].minorticks_off()
    ...
    axs[2].set_xlabel("Number of Shader Swaps")
    axs[2].set_ylabel("Time(s)")
    axs[2].set_yscale('log')
    axs[2].set_title("Total Time")
    axs[2].minorticks_off()
    ...
    axs[3].set_xlabel("Number of Shader Swaps")
    axs[3].set_ylabel("# AST Node")
    axs[3].set_title("Number of AST Nodes")
